class BookingTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @booking_type.save
        format.html { redirect_to @booking_type, notice: "Booking type was successfully created." }
  ...
  def update
    respond_to do |format|
      if @booking_type.update(booking_type_params)
        format.html { redirect_to @booking_type, notice: "Booking type was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to booking_types_path, status: :see_other, notice: "Booking type was successfully destroyed." }
  ...
  private
    ...
    def booking_type_params
      params.require(:booking_type).permit(:name, :location, :color, :duration, :payment_required, :price, :user_id)
    end
end
